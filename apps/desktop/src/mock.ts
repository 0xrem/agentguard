  ...
  const list: RuntimeProcessInfo[] = [
    {
      ...
      coverageReason: "Observed 62 audited event(s); most recent event 12s ago.",
      coverageConfidence: "high",
      coverageScore: 92,
      coverageEvidence: [
        { kind: "audit_link", label: "Last Audit Link", value: "12s ago", weight: 30 },
        { kind: "runtime_signal", label: "Observed Events", value: "62", weight: 55 },
      ],
      lastEventAtUnixMs: Date.now() - 12_000,
      cpu: 1.4,
      memory: 47.8,
      network: 12,
    ...
    },
    {
      ...
      status: "running",
      coverageStatus: "protected",
      coverageReason: "Observed 38 audited event(s); most recent event 20s ago.",
      coverageConfidence: "high",
      coverageScore: 87,
      coverageEvidence: [
        { kind: "audit_link", label: "Last Audit Link", value: "20s ago", weight: 30 },
        { kind: "runtime_signal", label: "Observed Events", value: "38", weight: 55 },
      ],
      lastEventAtUnixMs: Date.now() - 20_000,
      cpu: 2.1,
      memory: 55.2,
      network: 28,
      networkSource: "nettop_delta",
    ...
    },
    {
      ...
      status: "running",
      coverageStatus: "protected",
      coverageReason: "Observed 14 audited event(s); most recent event 45s ago.",
      coverageConfidence: "high",
      coverageScore: 78,
      coverageEvidence: [
        { kind: "agent_signature", label: "Agent Signature", value: "claude", weight: 35 },
        { kind: "audit_link", label: "Last Audit Link", value: "45s ago", weight: 30 },
        { kind: "runtime_signal", label: "Observed Events", value: "14", weight: 55 },
      ],
      lastEventAtUnixMs: Date.now() - 45_000,
      cpu: 8.6,
      memory: 382.1,
      network: 4,
      networkSource: "nettop_delta",
